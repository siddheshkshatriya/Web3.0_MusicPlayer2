// contracts/TaylorSwiftShakeItOff.sol
...
contract TaylorSwiftShakeItOff is ERC20, ERC20Capped {
    ...
    //constructor
    constructor()
        ERC20("TaylorSwiftShakeItOff", "TSSIO")
        ERC20Capped(100 * (10**decimals()))
    {
        ...
        geniusID = "499725";
        spotifyURI = "0cqRj7pUJDkTCEsJkx8snD";
