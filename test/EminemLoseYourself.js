...
describe("EminemLoseYourself contract", function () {
  let Contract;
  let songToken;
  let owner;
  let addr1;
  ...
  beforeEach(async function () {
    Contract = await ethers.getContractFactory("EminemLoseYourself");
